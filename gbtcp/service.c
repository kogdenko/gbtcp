...
static int gt_service_ctl_status(struct log *log, void *udata,
...
static int gt_service_del_cb(struct log *log, void *udata, int eno,
	char *old);
...
static void gt_service_listen(struct log *log, struct dlist *head);
